...
/// TODO create generic CustomVectorField for vector2,3 and 4.
...
public class CustomVector2Field : Vector2Field
{
    ...
    public string xLabel {
        get{
            return xFloatField.label;
        } 
        set{
            xFloatField.label = value;
        }
    }
    public string yLabel {
        get{
            return yFloatField.label;
        } 
        set{
            yFloatField.label = value;
        }
    }
